# tax-doc-sdk-tax1098ma

Software development kit to generate IRS Form 1098-MA as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1098Ma.sample.png" width="850"/>
